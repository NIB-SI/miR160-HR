...
raw.leaves <- raw
colnames(raw$counts[ , 1:18])
raw.leaves$counts <- raw$counts[ , 1:18]
group.leaves <- group[1:18]


# DEA for LEAVES subset
...
contrasts=makeContrasts("R_PVY_A-R_mock",
                                                     "R_PVY_B-R_mock",
                                                     "R_PVY_B-R_PVY_A",
                                                     "NahG_PVY_A-NahG_mock",
                                                     "NahG_PVY_B-NahG_mock",
                                                     "NahG_PVY_B-NahG_PVY_A",
                                                     "NahG_mock-R_mock",
                                                     "NahG_PVY_A-R_PVY_A",
                                                     "NahG_PVY_B-R_PVY_B",
                                                     levels=design)
...
fitL <- edgeR::voomLmFit(scaled_f, design, block = group.leaves, sample.weights = TRUE, plot= TRUE)
...
write.table(results_matrix.addcpms, file="RNA-Seq_results_matrix.txt", sep="\t", quote=TRUE, row.names=FALSE)

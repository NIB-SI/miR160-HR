...
- bowtie-build: /usr/bin/bowtie-build
- RNAplex: RNAplex 2.4.18
- GSTAr: GSTAr.pl version 1.0
- samtools:  Version: 1.9-210-g72d140b (using htslib 1.9-437-g71d8683)
...
3. Select:Schema V2 (2017 release)
 ...
 Extra weight in seed region: 1.5
 Seed region: 2 -  13 NT
 ```
